...
<div class="md:flex w-fit mx-auto mb-4 md:mb-12">
    ...
    <h1 class="mt-4 md:mt-12 dark:text-bgcolor text-center font-black text-5xl md:text-6xl">FORM 1 SELESAI</h1>
</div>
<h1 class="dark:text-bgcolor text-center font-medium text-2xl mb-24 md:mb-12">
...
<a href="{{ route('user.form.show', ['jawaban' => $jawaban, 'destination' => $nextDestination]) }}" class="flex items-center w-fit h-16 border-2 border-slate-300 rounded-full mx-auto mb-32">
    ...
    <img src="/dist/lanjutkan.png" alt="" class="dark:hidden w-12 h-12 mr-2">
    <img src="/dist/ArrowDown1.png" alt="" class="hidden dark:block w-12 h-12 mr-2 -rotate-90">
</a>
