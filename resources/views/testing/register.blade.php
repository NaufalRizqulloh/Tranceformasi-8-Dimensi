 ...
 <body class="bg-[#F7F1F1]">
     ...
     <form method="POST" action="{{ route('register') }}" class="max-w-sm mx-auto">
         ...
         <label for="tanggal_lahir" id="">
             <input type="date" name="tanggal_lahir" id="tanggal_lahir" placeholder="Nama Lengkap" onfocus="this.showPicker()" class="mb-2 rounded-md border-black ring-black mx-auto px-3 py-2 border shadow rounder w-full block text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500 focus:placeholder:text-transparent @if($errors->has('tanggal_lahir')) border-red-500 @endif" value="{{ old('tanggal_lahir') }}" oninput="removeRedBorder(this)" />
             @error('tanggal_lahir')
             <h1 class="text-red-600 -mt-2">{{ $message }}</h1>
             @enderror
         </label>
         ...
         <select id="domisili" name="domisili" size="1" class="mb-3 rounded-md border-black ring-black mx-auto px-3 py-2 border shadow rounder w-full block text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500 focus:placeholder:text-transparent @if(old('domisili') == '0') border-red-500 @endif" >
         ...
         <label for="status" id="">
             <select name="status" id="status" class="mb-3 rounded-md border-black ring-black mx-auto px-3 py-2 border shadow rounder w-full block text-sm placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500 focus:placeholder:text-transparent @if(old('status') == '0') border-red-500 @endif" oninput="removeRedBorder(this)">
