...
<body class="bg-primary md:bg-bgcolor h-[100vh]">
    <div class="flex space-x-0 justify-center">
            ...
            <div class="h-fit justify-center">
                ...
                <div class="flex space-x-20 justify-center">
                    <button class="w-48 md:w-32 border-solid rounded-2xl md:rounded-lg border-2 bg-[#F7F1F1] md:bg-transparent md:border-[#8404F4]">
                        <h1 class="text-[#8404F4] md:text-base text-center font-montserrat font-semibold italic my-4 md:m-1">Masuk</h1>
                    </button>
                    <button class="w-48 md:w-32 border-solid rounded-2xl md:rounded-lg border-2 md:bg-primary">
                        <h1 class="text-[#F7F1F1] md:text-base text-center font-montserrat font-semibold italic my-4 md:m-1">Daftar</h1>
                    </button>
                </div>
        ...
        <section class="hidden md:flex w-1/2 justify-center items-center bg-[#8404F4] h-[100vh]">
            <div class="">
                <img src="/dist/title.png" alt="title" class="hidden md:block w-9/12 mx-auto">
                <h1 class="font-montserrat justify-center align-middle text-center text-[#F7F1F1] italic mt-12 text-4xl">
                    SELF ASSESMENT
                </h1>
                <h1 class="font-montserrat justify-center align-middle text-center text-[#F7F1F1] italic mt-12 font-light text-xs">
                    PT. TRANCEFORMASI INDONESIA - 2023
                </h1>
            </div>
        </section>
