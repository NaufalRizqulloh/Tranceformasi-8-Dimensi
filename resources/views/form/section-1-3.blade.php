    ...
    <div class="mt-8 md:mt-12 mx-auto w-[90%] md:w-[80%] lg:w-[60%] h-fit border-2 rounded-[15px] lg:rounded-[50px] bg-[#FFFFFF]">
        ...
        <ul>
            <li class="flex h-auto">
                ...
                <div class="mt-8 text-center block align mx-auto h-auto w-[60%] text-md border-2 border-slate-400 rounded-full">
                    <h1 class="mt-[6px]">Memikirkan orang lain dahulu</h1>
                </div>
            ...
            <li class="flex h-auto">
                ...
                <div class="mt-8 text-center block align mx-auto h-auto w-[60%] text-md border-2 border-slate-400 rounded-full">
                    <h1 class="mt-[6px]">Suka bersain/kompetitif, suka tantangan</h1>
                </div>
            ...
            <li class="flex h-auto">
                ...
                <div class="mt-8 text-center block align mx-auto h-auto w-[60%] text-md border-2 border-slate-400 rounded-full">
                    <h1 class="mt-[6px]">Optimis, berpikir positif</h1>
                </div>
            ...
            <li class="flex h-auto mb-12">
                ...
                <div class="mt-8 text-center block align mx-auto h-auto w-[60%] text-md border-2 border-slate-400 rounded-full">
                    <h1 class="mt-[6px]">Sistematis, berpikir logis</h1>
                </div>
    ...
    <div class="mt-8 md:mt-12 mx-auto w-[90%] md:w-[80%] lg:w-[60%] h-fit border-2 rounded-[15px] lg:rounded-[50px] bg-[#FFFFFF]">
        ...
        <ul>
            ...
            <li class="flex h-auto">
                ...
                <div class="mt-8 text-center block align mx-auto h-auto w-[60%] text-md border-2 border-slate-400 rounded-full">
                    <h1 class="mt-[6px]">Ingin kesempatan baru</h1>
                </div>
    ...
    <div class="mt-8 md:mt-12 mx-auto w-[90%] md:w-[80%] lg:w-[60%] h-fit border-2 rounded-[15px] lg:rounded-[50px] bg-[#FFFFFF]">
        ...
        <ul>
            ...
            <li class="flex h-auto">
                ...
                <div class="mt-8 text-center block align mx-auto h-auto w-[60%] text-md border-2 border-slate-400 rounded-full">
                    <h1 class="mt-[6px]">Berorientasi pada hasil/profit/untung</h1>
                </div>
