...
<header class="w-full flex bg-[#8404F4] mb-10 drop-shadow-2xl absolute top-0 left-0 right-0">
...
<div id="overlay1" class="bg-white dark:bg-slate-800 dark:text-slate-300 top-0 right-0 w-3/12 h-full z-30">
